[English Version](https://github.com/XiaoYuOvO/MITE1.16.1Pub/blob/master/ChangeLogEN.md)
# v0.1.0-beta 更新日志
## 世界生成
* 现在生成世界时只能选择放大化或巨型生物群系
* 结构将会在玩家解锁了特定的进度后才会生成
* 移除了在湖底和河底的砂砾沉积盘
* 每128天才会重新生成一次动物
## 进度
* 增加了与世界结构相关的进度(尚不完全,有些结构的要求还没想好,有好的意见可以和我说)  
## 方块
* 使泥土和沙子一样受重力影响
...
* 难度锁定为困难
## GUI
* 世界选择界面只会显示支持的世界(由MITE1.16.1创建的世界)
